    ...
    <v-container class="full-height mx-3" fluid>
      ...
      <v-sheet dark class="my-3 mr-5" elevation="8">
        <v-slide-group v-model="model" class="px-3 pb-1" show-arrows>
          <v-slide-item v-for="pelicula in peliculas" :key="pelicula.nombre">            
            <v-card class="ma-2 mt-3" max-width=140px flat>
              <v-img :src="pelicula.imagen" class="align-end" 
                  gradient="to bottom, rgba(0,0,0,.1), rgba(0,0,0,.5)" height=180px>
                <v-card-subtitle v-text="pelicula.nombre" class="white--text"></v-card-subtitle>
              </v-img>
            </v-card>
          </v-slide-item>
        </v-slide-group>
      ...
      <h3 class="mt-2">Series pendientes</h3>

      <v-sheet dark class="my-3 mr-5" elevation="8">
        <v-slide-group v-model="model" class="px-3 pb-1" show-arrows>
          <v-slide-item v-for="serie in series" :key="serie.nombre">            
            <v-card class="ma-2 mt-3" max-width=140px flat>
              <v-img :src="serie.imagen" class="align-end" 
                  gradient="to bottom, rgba(0,0,0,.1), rgba(0,0,0,.5)" height=180px>
                <v-card-subtitle v-text="serie.nombre" class="white--text"></v-card-subtitle>
              </v-img>
            </v-card>
          </v-slide-item>
        </v-slide-group>
      ...
      <h3 class="mt-2">Últimos éxitos</h3>

      <v-sheet dark class="my-3 mr-5" elevation="8">
        <v-slide-group v-model="model" class="px-3 pb-1" show-arrows>
          <v-slide-item v-for="novedad in novedades" :key="novedad.nombre">            
            <v-card class="ma-2 mt-3" max-width=140px flat>
              <v-img :src="novedad.imagen" class="align-end" 
                  gradient="to bottom, rgba(0,0,0,.1), rgba(0,0,0,.5)" height=180px>
                <v-card-subtitle v-text="novedad.nombre" class="white--text"></v-card-subtitle>
              </v-img>
            </v-card>
          </v-slide-item>
        </v-slide-group>
